...
export const metadata: Metadata = {
  title: 'Amenities - Sikhar Darshan Hotel Govardhan',
  description: 'Discover our comprehensive amenities including 24/7 service, free Wi-Fi, parking, restaurant, and more for a comfortable spiritual stay.',
};

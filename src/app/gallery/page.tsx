...
export const metadata: Metadata = {
  title: 'Gallery - Sikhar Darshan Hotel Govardhan',
  description: 'Explore our photo gallery featuring our rooms, facilities, and the spiritual beauty of Govardhan.',
};

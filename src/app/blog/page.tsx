...
export const metadata: Metadata = {
  title: 'Blog - Sikhar Darshan Hotel Govardhan',
  description: 'Read our blog for travel tips, spiritual insights, and guides to exploring Govardhan and nearby sacred sites.',
};

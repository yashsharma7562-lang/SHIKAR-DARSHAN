...
export const metadata: Metadata = {
  title: 'Nearby Attractions - Sikhar Darshan Hotel Govardhan',
  description: 'Explore sacred sites near Sikhar Darshan: Govardhan Parikrama, Radha Kund, Kusum Sarovar, and more spiritual destinations in Govardhan.',
};
